...
| Molecular Oncologist (conditional) | oncokb, civic, clinical_trials, fda_approvals | Mutation, Biomarkers, Tumor[MeSH] |
...
| OncoKB | Mutation → therapy mapping | **ONCOKB_API_KEY** (free academic) |
| CIViC | Community-curated variant evidence | No (GraphQL) |
